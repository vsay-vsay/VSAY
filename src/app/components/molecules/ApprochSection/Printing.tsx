...
const PrintingApproach = () => {
  ...
  return (
    <section className="py-20 dark:bg-black relative overflow-hidden bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          <h2 className="text-5xl md:text-6xl font-extrabold text-gray-800 dark:text-gray-200 mb-6 tracking-tight">
        ...
        >
          {approaches.map((approach, index) => (
            <motion.div
              ...
              className="relative dark:bg-white/5 bg-black/5 backdrop-blur-xl rounded-2xl p-8 border border-black/10 dark:border-white/10 transform transition-all duration-300 hover:shadow-2xl hover:shadow-cyan-500/50 dark:hover:shadow-cyan-500/20  group"
            >
              <div className="absolute inset-0 bg-gradient-to-r from-cyan-500/20 dark:from-cyan-500/5 to-blue-500/20 dark:to-blue-500/5 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              <div className="text-cyan-400 mb-6 flex justify-center transform group-hover:scale-110 transition-transform duration-300">
                {approach.icon}
              </div>
              <h3 className="text-2xl font-bold dark:text-white text-black mb-4 tracking-wide">
                {approach.title}
              </h3>
...
export default PrintingApproach;